...
const TOOLS: MarketingTool[] = [
  ...
  // Latest batch — Tier 1 + Tier 2 inspired by it-tools.tech
  {
    id: 'chmod-calculator',
    name: 'Chmod Calculator',
    description: 'Toggle rwx for owner/group/other; get octal + symbolic.',
    category: 'sysadmin',
    icon: '755',
    badge: '🔥 Most Searched',
    searchVolume: '140K/mo',
    searchVolumeNum: 140_000,
    tags: ['chmod', 'permissions', 'unix', 'octal'],
    isNew: true,
    existingSlug: 'chmod-calculator',
  },
  {
    id: 'basic-auth-generator',
    name: 'Basic Auth Header',
    description: 'Generate Authorization: Basic base64(user:pass).',
    category: 'backend',
    icon: '🔐',
    badge: '',
    searchVolume: '35K/mo',
    searchVolumeNum: 35_000,
    tags: ['basic-auth', 'http', 'header', 'curl'],
    isNew: true,
    existingSlug: 'basic-auth-generator',
  },
  {
    id: 'mime-types',
    name: 'MIME Type Lookup',
    description: 'Search file extension or content type — image/png, .webp, etc.',
    category: 'backend',
    icon: '📄',
    badge: '',
    searchVolume: '70K/mo',
    searchVolumeNum: 70_000,
    tags: ['mime', 'content-type', 'extension'],
    isNew: true,
    existingSlug: 'mime-types',
  },
  {
    id: 'json-to-csv',
    name: 'JSON to CSV',
    description: 'Convert JSON arrays to clean CSV with optional flattening.',
    category: 'backend',
    icon: '⇄',
    badge: '🔥 Most Searched',
    searchVolume: '90K/mo',
    searchVolumeNum: 90_000,
    tags: ['json', 'csv', 'convert', 'spreadsheet'],
    isNew: true,
    existingSlug: 'json-to-csv',
  },
  {
    id: 'json-to-yaml',
    name: 'JSON to YAML',
    description: 'Convert JSON to clean YAML for K8s, Compose, GitHub Actions.',
    category: 'devops',
    icon: '⇄',
    badge: '',
    searchVolume: '60K/mo',
    searchVolumeNum: 60_000,
    tags: ['json', 'yaml', 'convert', 'kubernetes'],
    isNew: true,
    existingSlug: 'json-to-yaml',
  },
  {
    id: 'xml-formatter',
    name: 'XML Formatter',
    description: 'Pretty-print or minify XML; validates as it goes.',
    category: 'backend',
    icon: '< />',
    badge: '🔥 Most Searched',
    searchVolume: '110K/mo',
    searchVolumeNum: 110_000,
    tags: ['xml', 'format', 'pretty', 'minify'],
    isNew: true,
    existingSlug: 'xml-formatter',
  },
  {
    id: 'hmac-generator',
    name: 'HMAC Generator',
    description: 'Sign webhooks. SHA-1/256/384/512. Stripe & GitHub style.',
    category: 'security',
    icon: '✍',
    badge: '🔥 Most Searched',
    searchVolume: '110K/mo',
    searchVolumeNum: 110_000,
    tags: ['hmac', 'webhook', 'sign', 'sha256'],
    isNew: true,
    existingSlug: 'hmac-generator',
  },
  {
    id: 'totp-generator',
    name: 'TOTP / 2FA Generator',
    description: 'Generate Google Authenticator-style 6-digit codes.',
    category: 'security',
    icon: '🔢',
    badge: '🔥 Most Searched',
    searchVolume: '280K/mo',
    ...
    isNew: true,
    existingSlug: 'totp-generator',
  },
  {
    id: 'iban-validator',
    name: 'IBAN Validator',
    description: 'Validate bank IBANs with mod-97 + country length checks.',
    category: 'backend',
    icon: '🏦',
    badge: '',
    searchVolume: '40K/mo',
    searchVolumeNum: 40_000,
    tags: ['iban', 'bank', 'sepa', 'validate'],
    isNew: true,
    existingSlug: 'iban-validator',
  },
  {
    id: 'docker-run-to-compose',
    name: 'docker run → compose',
    description: 'Convert a docker run line into a compose service block.',
    category: 'devops',
    icon: '🐳',
    badge: '🔥 Most Searched',
    searchVolume: '90K/mo',
    searchVolumeNum: 90_000,
    tags: ['docker', 'compose', 'convert', 'yaml'],
    isNew: true,
    existingSlug: 'docker-run-to-compose',
  },
  {
    id: 'rot13',
  ...
  },
  {
    ...
    badge: '',
    searchVolume: '50K/mo',
    searchVolumeNum: 50_000,
    tags: ['roman', 'numeral', 'convert'],
    isNew: true,
    existingSlug: 'roman-numerals',
  },
  {
    id: 'nato-phonetic',
    name: 'NATO Phonetic Alphabet',
    description: 'A → Alpha, B → Bravo, … for spelling over the phone.',
    category: 'sysadmin',
    icon: 'Aα',
    badge: '',
    searchVolume: '40K/mo',
    ...
    isNew: true,
    existingSlug: 'nato-phonetic',
  },
  {
    id: 'list-converter',
    name: 'List Converter',
    description: 'Newline ↔ CSV ↔ JSON array ↔ SQL IN. Dedupe, sort, trim.',
    category: 'backend',
    icon: '⫴',
    badge: '',
    searchVolume: '50K/mo',
    searchVolumeNum: 50_000,
    tags: ['list', 'csv', 'json', 'sql'],
    isNew: true,
    existingSlug: 'list-converter',
  },
  {
    id: 'email-normalizer',
    name: 'Email Normalizer',
    description: 'Canonical form — strip Gmail dots + tag aliases.',
    category: 'security',
    icon: '✉',
    badge: '',
    searchVolume: '30K/mo',
    searchVolumeNum: 30_000,
    tags: ['email', 'normalize', 'gmail', 'dedupe'],
    isNew: true,
    existingSlug: 'email-normalizer',
  },
  {
    id: 'safelink-decoder',
    name: 'Safelink Decoder',
    description: 'Unwrap Outlook, Mimecast, Proofpoint redirect URLs.',
    category: 'security',
    icon: '🔓',
    badge: '',
    searchVolume: '35K/mo',
    searchVolumeNum: 35_000,
    tags: ['safelink', 'outlook', 'mimecast', 'proofpoint'],
    isNew: true,
    existingSlug: 'safelink-decoder',
  },
  {
    id: 'wifi-qr',
    name: 'Wi-Fi QR Code',
    description: 'QR that joins a Wi-Fi network when scanned.',
    category: 'sysadmin',
    icon: '📶',
    badge: '✨ New',
    searchVolume: '90K/mo',
    searchVolumeNum: 90_000,
    tags: ['wifi', 'qr', 'wpa', 'guest'],
    isNew: true,
    existingSlug: 'wifi-qr',
  },
  {
    id: 'ulid-generator',
    name: 'ULID Generator',
    description: 'Sortable 26-char IDs. Decode any ULID to its timestamp.',
    category: 'backend',
    icon: '◫',
    badge: '',
    searchVolume: '25K/mo',
    searchVolumeNum: 25_000,
    tags: ['ulid', 'uuid', 'sortable', 'id'],
    isNew: true,
    existingSlug: 'ulid-generator',
  },
  {
    id: 'token-generator',
    name: 'API Token Generator',
    description: 'Random API tokens. base64url, hex, prefixed (sk_live_…).',
    category: 'security',
    icon: '🪙',
    badge: '',
    searchVolume: '70K/mo',
    searchVolumeNum: 70_000,
    tags: ['token', 'api', 'key', 'secret'],
    isNew: true,
    existingSlug: 'token-generator',
  },
  {
    id: 'math-evaluator',
    name: 'Math Evaluator',
    description: 'Evaluate expressions: sqrt, sin, log, pow, PI, E.',
    category: 'backend',
    icon: '∑',
    badge: '',
    searchVolume: '60K/mo',
